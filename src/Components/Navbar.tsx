                 ...
                 <div className="flex flex-row items-center justify-center space-x-10">
                    ...
                    navLinks.map((singleNavLink)=> (
                        <div key={singleNavLink.title}>
                              {
                                singleNavLink.title === 'Contacts' ? <button  className="contact_button"><a href={singleNavLink.href} >{singleNavLink.title}</a></button> : <button ><a href={singleNavLink.href} className="navlink">{singleNavLink.title}</a></button>
                              }
                        </div>
                    ))
                  }
